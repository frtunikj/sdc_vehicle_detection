...
* [02_classifier.ipynb](https://github.com/frtunikj/sdc_vehicle_detection/blob/master/02_classifier.ipynb) - loads and preprocesses training and testing labeled data, trains and exaluates the linear SVM classifier. 
